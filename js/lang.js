const translations = {
  en: {
    ...
    "trabajamos.title2": "Diagnosis",
    "trabajamos.title3": "Findings",
    "trabajamos.title4": "Value proposition",
    "trabajamos.title5": "Implementation",
    "trabajamos.title6": "Delivery",
    "trabajamos.title7": "Feedback",
    
    "trabajamos.paragraph1": "We connect with you to understand your business and goals.",
    "trabajamos.paragraph2": "We analyze the current situation and identify opportunities for improvement.",
    "trabajamos.paragraph3": "We present the results with clear and actionable information.",
    "trabajamos.paragraph4": "We design a solution tailored to your needs.",
    "trabajamos.paragraph5": "We implement the plan with modern and efficient methodologies.",
    "trabajamos.paragraph6": "We formalize the results and measure the impact generated.",
    "trabajamos.paragraph7": "We close with feedback to continually improve and strengthen the relationship.",
    
    //SECCION CARDS
    "card.title1": "Impact of the data-driven approach",
    "card.title2": "Improved productivity and profitability with analytics",
    "card.title3": "Success in project management",
    ...
    "form.name": "Name",
    "btnprivacy": "<a class='btn-privacy' target='_blank' href='./assets/pdf/Privacy Policy_R0.pdf'>Privacy Policy</a>",
    "textprivacy": "By submitting this form, you agree to our <a class='privacytext' target='_blank' href='./assets/pdf/Privacy Policy_R0.pdf'>Privacy Policy</a>",
  ...
  es: {
    ...
    "trabajamos.title1": "Contacto",
    "trabajamos.title2": "Diagnóstico",
    "trabajamos.title3": "Hallazgos",
    "trabajamos.title4": "Propuesta de valor",
    "trabajamos.title5": "Implementación",
    "trabajamos.title6": "Entrega",
    "trabajamos.title7": "Feedback",
    "trabajamos.paragraph1": "Conectamos contigo para entender tu negocio y objetivos.",
    "trabajamos.paragraph2": "Analizamos la situación actual y detectamos oportunidades de mejora.",
    "trabajamos.paragraph3": "Te presentamos los resultados con información clara y accionable.",
    "trabajamos.paragraph4": "Diseñamos una solución adaptada a tus necesidades.",
    "trabajamos.paragraph5": "Ponemos en marcha el plan con metodologías modernas y eficientes.",
    "trabajamos.paragraph6": "Formalizamos los resultados y medimos el impacto generado.",
    "trabajamos.paragraph7": "Cerramos con retroalimentación para mejorar continuamente y fortalecer la relación.",

    //SECCION CARDS
    "card.title1": "Impacto del enfoque data-driven",
    "card.title2": "Productividad y rentabilidad mejoradas con analítica",
    "card.title3": "Éxito en gestión de proyectos",
    "card.title4": "Tasa de éxito de proyectos en 'champions'",
    ...
    "form.email": "E-mail",
    "btnprivacy": "<a class='btn-privacy' target='_blank' href='./assets/pdf/Politica_de_Privacidad_R0.pdf'>Política de Privacidad</a>",
    "textprivacy": "Al enviar este formulario, usted acepta nuestra <a class='privacytext' target='_blank' href='./assets/pdf/Politica de Privacidad_R0.pdf'>Política de Privacidad</a>",
    "form.phone": "Teléfono",
